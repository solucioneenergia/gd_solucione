...
from automacao_gd.infrastructure.portal import cdp_summary as cdp_summary_helpers
...
def _initial_download_summary(
    ...
    return cdp_summary_helpers.initial_download_summary(
        started_at,
        downloads_root,
        max_completed,
        reprocess_existing_pdfs,
...
def _download_result_from_record(record: PortalSolicitation) -> dict:
    return cdp_summary_helpers.download_result_from_record(record)
...
def _result_has_valid_pdf_for_processing(result: dict) -> bool:
    return cdp_summary_helpers.result_has_valid_pdf_for_processing(result)


def _result_is_metadata_only_for_processing(result: dict) -> bool:
    return cdp_summary_helpers.result_is_metadata_only_for_processing(result)


def _refresh_download_totals(summary: dict) -> None:
    cdp_summary_helpers.refresh_download_totals(summary)
