...
`docs/adr/` é o local canônico. Novas ADRs usam `NNNN-slug-em-kebab-case.md`, o [template oficial](../templates/ADR_TEMPLATE.md) e a próxima numeração disponível calculada somente neste diretório.
