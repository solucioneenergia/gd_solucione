...
| EXT-004 | Staging absoluto do ledger existe | artefato | `Test-Path C:\CAMINHO\SINTETICO | 0 | encontrado | Confirmado por artefato |
...
| EXT-010 | Agregado do bundle registrado | manifesto | `artifact-manifest.json` | 0 | `F[PROTOCOLO REDIGIDO]CB709E021BE97DEAB65D688F01B45E5D5DCA9959B4B77E422E096`; algoritmo não localizado para recomputação independente | Confirmado por artefato |
