...
Para o saneamento do protocolo `[PROTOCOLO REDIGIDO]`, a unica escrita autorizada foi a criacao da linha aprovada na aba `2026`, sem alterar registros existentes.
