...
def test_navigate_to_numeric_page_uses_target_after_forward_window_shift(
    ...
    active_page = {"value": 1}
    window_state = {"tail_visible": False}
    numeric_targets = []
    next_window_clicks = []
    ...
    def fake_direct_numeric_click(page, current_page_number: int):
        ...
        if target == 15 and window_state["tail_visible"]:
            active_page["value"] = 15
            return {
                "found": True,
                "enabled": True,
                "clicked": True,
                ...
                "current_page_number": current_page_number,
                "target_page_number": target,
                "numeric_page_links_found": ["13", "14", "15"],
                "numeric_page_links_count": 3,
                "stop_reason": "pagination_numeric_page_clicked",
            }
        return {
            ...
            "numeric_page_links_found": (
                ["13", "14", "15"] if window_state["tail_visible"] else ["1", "2", "3"]
            ),
            "numeric_page_links_count": 3,
            "stop_reason": "pagination_numeric_target_not_found",
        }

    def fake_next_window(page):
        next_window_clicks.append(active_page["value"])
        window_state["tail_visible"] = True
        return {
            "found": True,
            "enabled": True,
            "clicked": True,
