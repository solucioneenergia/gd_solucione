...
def _base_workbook(path: Path) -> Path:
    ...
    for sheet in wb.worksheets:
        ...
        _row(sheet, 3, "Cliente 1", "2500000001", "2025-01-10", None, True, "1x MOD A", "1x INV A")
...
def test_adaptive_height_archetypes_are_distinct(tmp_path: Path) -> None:
    ...
    wb = load_workbook(path)
    ws = wb["2025"]
    _row(ws, 4, "Cliente 2", "2500000002", "2025-01-11", None, True, "A\nB", "I")
    ws.row_dimensions[4].height = 36
    _row(ws, 5, "Cliente 3", "2500000003", "2025-01-12", None, True, "A\nB\nC", "I")
...
def test_visual_difference_in_canonical_reference_becomes_safe_style_action(tmp_path: Path) -> None:
    ...
    wb = load_workbook(path)
    ws = wb["2025"]
    _row(ws, 4, "Cliente 2", "2500000002", "2025-01-11", None, True, "1x MOD B", "1x INV B")
